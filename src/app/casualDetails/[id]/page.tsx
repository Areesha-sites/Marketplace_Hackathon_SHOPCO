...
const casualDetails: React.FC<Props> = ({ params }) => {
  ...
  const { id } = params;
  const product = casualCardsData.find((item: any) => item.id === id);
  if (!product) {
    return (
      <div className="text-center mt-10">
        <h1 className="text-2xl font-bold">Product Not Found</h1>
        <button
          onClick={() => (window.location.href = "/casualDetails")}
    ...
    <>
      <section>
        ...
        <p
          data-aos="fade-right"
          data-aos-delay="400"
          className="absolute md:top-[573px] top-[947px] font-satoshiBold md:left-[750px] text-[16px] font-normal text-black text-opacity-60 left-[16px]"
        >
          Choose Size
        </p>
        <div
        ...
        >
          <button className="md:w-[86px] md:h-[46px] w-[74px] h-[39px] md:py-[12px]  md:px-[24px] py-[10px] px-[24px] rounded-[62px] bg-bgLightGrayColor md:text-[15px] text-[14px] font-normal text-black/60 font-satoshi flex justify-center items-center font-inter ">
            Small
          </button>
          <button className="md:w-[105px] font-satoshi md:h-[46px] w-[90px] h-[39px]  md:py-[12px] md:px-[24px] rounded-[62px] bg-bgLightGrayColor md:text-[15px] text-[14px] font-normal text-black/60 py-[10px] px-[20px] flex justify-center items-center font-inter">
            Medium
          </button>
          <button className="md:w-[89px] font-satoshi md:h-[46px] w-[76px] h-[39px] md:py-[12px] md:px-[24px] py-[10px] px-[20px] rounded-[62px] bg-bgLightGrayColor text-[15px] font-normal bg-black text-white flex justify-center items-center font-inter">
            large
          </button>
          <button className="md:w-[104px] font-satoshi md:h-[46px] md:py-[12px] md:px-[24px] w-[80px] h-[39px] py-[10px] px-[20px] rounded-[62px] bg-bgLightGrayColor md:text-[15px] text-[14px] font-normal text-black/60 whitespace-nowrap text-center flex justify-center items-center font-inter">
            X-Large
          </button>
        </div>
        <div
        ...
        <button
          data-aos="zoom-in"
          data-aos-delay="300"
          className="md:w-[400px] md:h-[52px] h-[44px] absolute md:top-[694px] md:left-[940px] top-[1080px] py-[16px] px-[54px] rounded-[62px] bg-black text-white font-satoshi text-[14px] md:text-[16px] font-medium items-center flex justify-center font-inter w-[236px] left-[138px] "
        >
          Add to Cart
        </button>
        <h3
