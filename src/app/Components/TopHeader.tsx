  ...
  return (
    <>
      <header className="md:w-[1440px] w-[390px] md:h-[38px] h-[34px] bg-black">
        <p className="w-[351px] h-[19px] md:absolute md:top-[9px] left-[544px] text-whiteBgColor md:text-[14px] text-[12px] font-normal whitespace-nowrap md:p-0 py-[9px] mx-auto">
