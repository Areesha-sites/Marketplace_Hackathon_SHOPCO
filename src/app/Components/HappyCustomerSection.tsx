...
const HappyCustomerSection = () => {
  return (
    <>
      <section>
        <h1 className="absolute lg:top-[3363px] xl:top-[3263px] top-[3170px] md:left-[100px] xxl:left-[100px] xl:left-[50px] left-[16px] text-[32px] xl:text-[48px] font-extrabold text-blackBgColor leading-[36px] tracking-wider font-integralCf lg:left-[100px] lg:text-[40px]">
          OUR HAPPY CUSTOMERS
        </h1>
