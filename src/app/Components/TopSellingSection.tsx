    ...
    <>
      <section>
        <h1
          // data-aos="zoom-in"
          // data-aos-delay="200"
          className="absolute md:top-[1250px] lg:top-[1500px] xxl:top-[1660px] xl:top-[1600px] text-blackBgColor md:text-[48px] font-extrabold text-center text-[25px] sm:text-[32px] top-[1650px] tracking-wider font-integralCf w-full"
        >
          top selling
        </h1>
        <div className="">
