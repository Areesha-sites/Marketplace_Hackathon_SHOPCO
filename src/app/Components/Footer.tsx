...
const Footer = () => {
  return (
    ...
    <NewsLetter />
        ...
        <footer className=" bg-BannerBgColor py-6 px-0 lg:px-12 min-h-screen md:h-auto w-full mx-auto">
          <div className=" xl:justify-center xl:gap-[70px] lg:flex-row flex-col flex justify-between gap-y-[20px] md:flex-row px-3">
...
<div className="">
<div className="grid grid-cols-2 gap-y-[20px] md:grid-cols-4">
  <div className=" flex flex-col md:gap-[26px] gap-[16px] ">
              ...
              <Link
                href="/"
                className="font-satoshi font-normal text-[14px] lg:text-[16px] leading-[19px] text-[#000000] opacity-[60%] hover:text-black hover:opacity-100 transition-all duration-300 ease-in-out"
              >
                About
              </Link>
              <Link
             ...
             <div className="flex flex-col md:gap-[26px] gap-[16px] ">
              <Link
                href="/"
                className=" font-medium leading-[18px] tracking-[3px] font-satoshiBold text-[14px]"
              >
                HELP
              </Link>
              <Link
      ...
      <div className="flex flex-col md:gap-[26px] gap-[16px] ">
              <Link
                href="/"
                className=" font-satoshiBold font-medium leading-[18px] tracking-[3px] text-[14px]"
              >
                FAQ
              </Link>
              <Link
              ...
              <Link
                href="/"
                className="font-satoshi font-normal text-[14px] lg:text-[16px] leading-[19px] text-[#000000] opacity-[60%] whitespace-nowrap hover:text-black hover:opacity-100 transition-all duration-300 ease-in-out"
              >
                Manage Delievries
              </Link>
              <Link
            ...
            <div className="flex flex-col md:gap-[26px] gap-[16px] ">
              ...
              <Link
                href="/"
                className="font-satoshi font-normal lg:text-[16px] text-[14px] leading-[19px] text-[#000000] opacity-[60%] hover:text-black hover:opacity-100 transition-all duration-300 ease-in-out"
              >
                Free eBooks
              </Link>
              <Link
