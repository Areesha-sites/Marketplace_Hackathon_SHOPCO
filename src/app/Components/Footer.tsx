...
const Footer = () => {
  return (
    <>
      ...
      <footer className="md:w-[1440px] xxl:w-[1440px] xl:w-[1277px] md:h-[499px] absolute bg-[#F0F0F0] w-[392px] h-[846px]">
        <div className="md:w-[1240px] h-[177px] relative md:left-[100px] xxl:left-[100px] xl:left-[20px] md:top-[130px]  flex md:justify-between xxl:justify-between xl:justify-center xl:gap-[100px] md:flex-row flex-col top-[200px] ">
          ...
          <div className="md:w-[104px] md:h-[177px] w-[91px] h-[146px] flex flex-col md:gap-[26px] gap-[16px] md:static relative top-[120px] left-[16px] xl:left-[]">
        ...
        <div className="md:w-[1240px] w-[358px] relative md:left-[100px] xxl:left-[50px] xl:left-[50px] xl:w-[1150px] md:top-[240px]  border-[1px] border-[#000000] border-opacity-[10%] left-[16px] top-[560px]"></div>

        <span className="md:w-[269px] h-[19px] relative  md:left-[100px] xxl:left-[100px] xl:left-[50px] left-[61px] font-satoshi font-normal text-[14px] leading-[18.9px] text-right text-[#00000] opacity-[60%] whitespace-nowrap md:top-[260px] top-[573px]">
          Shop.co © 2000-2023, All Rights Reserved
        </span>

        <div className="md:w-[281.07px] h-[30.3px] w-[240px] relative  md:left-[1059px] xxl:left-[1059px] xl:left-[925px] flex justify-between md:gap-[12px] top-[583px] left-[74px] gap-[10px] md:top-[235px]">
