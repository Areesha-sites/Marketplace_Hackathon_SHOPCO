  ...
  return (
    <>
      <section className="md:w-[1440px] h-[663px] absolute md:top-[134px] top-[98px] bg-BannerBgColor w-[390px]">
        ...
        />
        <h1 className="md:w-[577px] md:h-[173px] absolute md:top-[100px] md:left-[100px] md:text-[64px] text-[36px] md:leading-[64px] leading-[34px] text-blackBgColor z-20 w-[315px] h-[93px] top-[40px] left-[16px] font-extrabold tracking-tight">
          FIND CLOTHES THAT MATCHES YOUR STYLE
        </h1>
        <p className="absolute md:top-[308px] md:left-[100px] md:text-[16px] font-inter font-normal text-black/60 text-opacity-60 md:w-[640px] md:leading-[22px] z-20 w-[358px] h-[50px] top-[160px] left-[16px] text-[14px] leading-[20px]">
          Browse through our diverse range of meticulously crafted garments,
          designed to bring out your individuality and cater to your sense of
          style.
        </p>
        <button className="md:w-[210px] h-[52px] absolute md:top-[375px] md:left-[100px] md:py-[16px] md:px-[54px] rounded-[62px] bg-blackBgColor font-inter text-[16px] font-medium text-whiteBgColor flex items-center justify-center z-20 w-[358px] left-[16px] top-[238px]">
          Shop Now
        </button>
        <div className="w-[278px] h-[52px] absolute top-[310px] left-[56px] flex justify-between md:hidden">
          <div className="w-[106px] h-[48px] flex flex-col">
            <h2 className="text-[24px] font-bold font-inter text-blackBgColor">
              200+
            </h2>
            <p className="font-inter text-[12px] font-normal text-black text-opacity-60 whitespace-nowrap">
      ...
      <div className="md:w-[1440px] w-[390px] h-[146px] md:h-[122px] md:top-[797px] absolute bg-blackBgColor top-[951px] md:flex md:justify-between md:items-center ">
        ...
        <Image
          ...
          height={33.16}
          width={166.48}
          className="md:h-[33.16px] md:w-[146.48px] h-[26.65px] w-[63.81px] absolute md:left-[372.48px] left-[166.74px] top-[40px] md:top-[50px]"
        />
        <Image
          src="/brand-logo3.svg"
          alt="brand-logo"
