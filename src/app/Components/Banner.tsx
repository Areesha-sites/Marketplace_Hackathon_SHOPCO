  ...
  return (
    <>
      <div className="flex justify-center items-center w-full">
        <section className="md:w-full xxl:w-[1440px] xl:w-full absolute xl:top-[200px] py-14 top-[98px] bg-BannerBgColor w-full mx-auto lg:w-full lg:top-[130px] xxl:top-[230px] flex justify-center items-center">
