      ...
      >
        <div className="flex justify-center items-center w-full mx-auto">
          <Image
            ...
            height={56}
            width={56}
            className="xl:w-[56px] xl:h-[56px] absolute xxl:left-[785px] md:top-[160px] xxl:top-[200px] xl:left-[685px] z-20 w-[44px] h-[44px] top-[430px] left-[17px] sm:left-[27px] star-rotate xl:top-[200px] md:left-[400px] lg:left-[560px] lg:top-[200px] "
          />
          ...
          <Image
            ...
            height={104}
            width={104}
            className="xl:w-[104px] xl:h-[104px] sm:w-[76px] sm:h-[76px] h-[50px] w-[50px] absolute md:left-[670px] xxl:left-[1250px] xxl:top-[0px] xl:left-[1100px] md:top-[20px] z-20 top-[340px] right-[15px] sm:right-[18px] star-rotate xl:top-[0px] lg:top-[50px] lg:left-[920px] lg:w-[80px] lg:h-[80px] "
          />
        </div>
      </section>
      <div
