    ...
    <>
      <div className="flex justify-center items-center w-full">
        <section
          // data-aos="zoom-up"
          // data-aos-delay="200"
          className="md:w-full xxl:w-[1440px] xl:w-full absolute xl:top-[200px] py-14 top-[98px] bg-BannerBgColor w-full mx-auto lg:w-full lg:top-[130px] xxl:top-[230px] flex justify-center items-center"
        >
      ...
      <div
        // data-aos="zoom-in"
        // data-aos-delay="100"
        className=" xxl:w-[1440px] xl:w-full w-full sm:w-full h-[146px] md:h-[122px] xxl:h-[122px] md:top-[465px] lg:top-[590px] xxl:top-[797px] xl:top-[723px] absolute bg-black top-[1000px] flex justify-center sm:flex-row flex-wrap gap-x-[40px] px-[8px] items-center lg:w-full gap-y-0"
      >
        <Image
          // data-aos="fade-right"
          // data-aos-delay="200"
