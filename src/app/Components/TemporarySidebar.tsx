  ...
  return (
    <>
      <aside
        ...
        className="lg:w-[295px] w-full h-[1130px] md:h-[1220px] absolute md:top-[204px] top-[93px] xl:left-[100px] py-[20px] px-[24px] flex flex-col gap-[24px] rounded-[20px] border-[1px] border-black/10 z-50 bg-white lg:left-[50px]"
      >
        ...
        <div className="lg:w-[247px] w-full h-[160px] flex flex-col gap-[20px]">
          <div className="lg:w-[247px] w-full h-[16px] justify-between flex">
        ...
        <div className="lg:w-[247px] w-full h-[171px] flex flex-col gap-[20px] md:static relative top-[-83px]">
          ...
          <div className="lg:w-[247px] w-full h-[124px] flex flex-col gap-[20px]">
            ...
            <div className="lg:w-[247px] w-full h-[16px] justify-between flex">
              <span className="lg:w-[247px] w-full font-normal text-black text-opacity-60 font-satoshi">
                Formal
              </span>
              <Image
                src="/side-chveron.svg"
        ...
        <button className="lg:w-[247px] w-full h-[48px] py-[16px] px-[54px] rounded-[62px] bg-black text-white flex items-center justify-center text-[14px] font-medium font-satoshi md:static relative top-[-83px] hover:bg-black/85">
          Apply Filter
        </button>
      </aside>
    </>
