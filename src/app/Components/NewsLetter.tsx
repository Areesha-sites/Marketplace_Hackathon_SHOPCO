...
const NewsLetter = () => {
  return (
    <div className='w-[1240px] h-[180px] absolute top-[3781px] left-[100px] z-20 rounded-[20px] flex justify-between pt-[36px] pr-[64px] pb-[36px] pl-[64px] bg-[#000000]'>
        ...
        <div className='w-[349px] h-[108px] flex flex-col gap-[14px]'>
            <div className='w-[349px] h-[48px] rounded-[62px] pt-[12px] pr-[16px] pb-[12px] pl-[16px] flex gap-[12px] bg-[#ffffff]'>
                <Image src="/Frame (2).svg" alt="email.img" height={20} width={20} className="w-[24px] h-[24px]"/>
