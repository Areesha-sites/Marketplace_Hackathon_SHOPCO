      ...
      <Link href={`/productDetailsCard/${id}`} passHref>
        <div className="h-[420px] ">
          <div
            ...
            className="md:w-[295px] md:h-[298px] xxl:w-[295px] xxl:h-[298px] xl:w-[275px] xl:h-[298px] sm:w-[180px] sm:h-[200px] rounded-[20px] bg-BannerBgColor top-[1991px] w-[60px] h-[90px]"
          >
            <div className="relative">
              <Image
                ...
                height={296}
                width={444}
                className="md:w-[444px] md:h-[296px] sm:w-[180px] w-[60] h-[190px] object-cover rounded-[20px] transition-transform duration-300 ease-in-out"
              />
