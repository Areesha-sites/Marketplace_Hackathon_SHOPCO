  ...
  return (
    <>
      <section className="h-[2470px]">
        <div className="absolute top-[120px] lg:top-[150px] xl:top-[160px] left-[20px] lg:left-[100px] md:left-[40px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink>
                  <Link href="/women" className="font-satoshi">
                    Shop
                  </Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>
                  <Link href="/womenDetails" className="font-satoshi">
                    Women
                  </Link>
                </BreadcrumbPage>
              </BreadcrumbItem>
        ...
        <div className="absolute xl:top-[2470px] xxl:top-[2872px] top-[2800px]">
          <Footer />
        </div>
