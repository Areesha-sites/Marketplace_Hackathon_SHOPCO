...
const MenDetails: React.FC<Props> = ({ params }) => {
    const { id } = params;
    ...
    useEffect(() => {
      const fetchProduct = async () => {
        const query = `*[_type=="men" && _id==$id][0]{
          _id,
          name,
          description,
          price,
  ...
  return (
    <>
      <section className="h-[2000px]">
        <div className="absolute top-[120px] lg:top-[150px] xl:top-[160px] left-[20px] lg:left-[100px] md:left-[40px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>
                  <Link href="/menDetails" className="font-satoshi">
                    Men
                  </Link>
                </BreadcrumbPage>
              </BreadcrumbItem>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full px-7 gap-x-[50px] lg:gap-x-[20px] xxl:gap-x-[0px] xl:px-16 xl:mt-[-10px] lg:mt-[130px] xxl:mt-[-50px] 2xl:mt-[-100px]">
          <div className="flex justify-center items-center w-full mx-auto md:flex-row-reverse flex-col sm:px-3 lg:px-0 lg:gap-x-[10px] md:mt-[70px] mt-[70px] lg:mt-[-100px] xxl:mt-[150px] 2xl:mt-[200px] xl:mt-[50px] gap-y-[10px]">
            <div className="flex justify-center items-center w-full">
              <Image
                ...
                height={530}
                width={444}
                className="md:w-[444px] lg:h-[450px] 2xl:w-[500px] xxl:h-[530px] xxl:w-[480px] xl:h-[470px] md:h-[500px] sm:h-[350px] rounded-[20px] bg-productDetailBbImageColor h-[290px] sm:w-[358px] w-[300px] hue-rotate-30"
              />
            </div>
          ...
          <div className="flex flex-col gap-y-[10px] mt-[40px] lg:mt-[-50px] xl:mt-[100px] justify-start lg:px-0 xxl:mt-[140px] 2xl:mt-[210px]">
        ...
        <div className="absolute xl:top-[1870px] xxl:top-[2872px] top-[2800px]">
          <Footer />
        </div>
