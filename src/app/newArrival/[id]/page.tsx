...
const NewArrivalDetails: React.FC<Props> = ({ params }) => {
  ...
  //       ? { ...item, quantity: item.quantity + 1, price: item.basePrice * (item.quantity + 1) } // Update price here
  //       : item
  //   );
  //   setCart(updatedCart);
  ...
  //       updatedCart[existingProductIndex].basePrice *
  //       updatedCart[existingProductIndex].quantity; // Update total price
  //     setCart(updatedCart);
  //     localStorage.setItem("cart", JSON.stringify(updatedCart));
  //   }
  // };
      ...
      <section className="h-[3000px]">
        ...
        <div className="flex justify-center items-center w-full mx-auto">
          <Image
            ...
            height={530}
            width={444}
            className="md:w-[444px] md:h-[500px] absolute md:top-[216px] md:left-[266px] rounded-[20px] bg-productDetailBbImageColor sm:h-[290px] sm:w-[358px] w-[285px] h-[290px] top-[170px]  "
          />
          <div className="flex justify-center items-center w-full mx-auto">
            <Image
              // data-aos="flip-up"
        ...
        <div className="absolute xl:top-[3070px] xxl:top-[2872px] top-[2800px]">
          <Footer />
        </div>
