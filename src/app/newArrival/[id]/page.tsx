  ...
  const { id } = params;
     ...
     useEffect(() => {
       const fetchProduct = async () => {
         const query = `*[_type=="newArrivals" && _id==$id][0]{
           _id,
           name,
           description,
           price,
  ...
  return (
    <>
      <section className="h-[2250px]">
        <div className="absolute top-[120px] lg:top-[150px] xl:top-[160px] left-[20px] lg:left-[100px] md:left-[40px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>
                  <Link href="/newArrival" className="font-satoshi">
                    New Arrivals
                  </Link>
                </BreadcrumbPage>
              </BreadcrumbItem>
        ...
        <div className="absolute xl:top-[2770px] xxl:top-[2872px] top-[2800px]">
          <Footer />
        </div>
