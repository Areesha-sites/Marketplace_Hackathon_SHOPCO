  ...
  return (
    <>
      <section className="">
        ...
        className="w-[400px] h-[52px] absolute top-[694px] left-[940px] py-[16px] px-[54px] rounded-[62px] bg-black text-white text-[16px] font-medium font-satoshi">
          Add to Cart
        </button>
