      ...
      <div>
        {wishlist.length === 0 ? (
          <div className="flex flex-col justify-center gap-y-[10px] w-full items-center mx-auto min-h-screen mt-10">
            <h1 className="font-integralCf text-[23px] md:text-[28px] text-black text-center font-extrabold tracking-wider">
              Your Wishlist
            </h1>
          ...
          <div className="flex flex-col items-center h-auto pt-[150px] xl:pt-[190px] lg:pt-[180px] lg: lg:mt-0 w-full mx-auto gap-y-[20px] justify-center">
            <div className="flex justify-start items-start w-full px-7 xl:px-32 mt-[-50px]">
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem>
                    <BreadcrumbLink>
            ...
            <div className="overflow-auto w-full h-[500px] px-6 xl:px-20">
              <div className="grid min-w-[1000px] grid-cols-5 px-6 py-2 bg-BannerBgColor border-b-[1px] border-black/90 rounded-[4px] font-satoshiBold text-center sticky top-0 z-10">
                <div>Product</div>
              ...
              <div className="flex flex-col gap-y-4 w-full">
                {wishlist.map((item) => (
                  <div
                    key={item._id}
                    className="grid min-w-[1000px] grid-cols-5 items-center px-6 py-4 border-b-[1px] border-gray-300 font-satoshi text-center"
                  >
                    <div>
                      <Image
                        height={64}
                    ...
                    <div className="flex gap-x-2 justify-center">
                      ...
                      <button
                        onClick={() => {
                          const product: CasualDetailsProducts = {
                            _id: item._id,
                            name: item.name,
